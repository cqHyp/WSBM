...
public class NewsRoadAdapter extends BaseFooterAdapter<News> {
    ...
    public NewsRoadAdapter(Context context, List<News> data ,View footer) {
        super(context, data);
        this.footer=footer;
    }
    ...
    public BaseItem initItem(ViewGroup parent) {
        View view=getInflater().inflate(R.layout.item_news_road,parent,false);
