...
import com.qiqi.edmond.qishop.interfaces.mvp.models.NewsFoodModelInterface;
...
public class NewsFoodModel extends BaseModel<NewsNobannerData> implements NewsFoodModelInterface {
    public static final int COUNT = 5;
    private int lastId = 0;

    @Override
    public void init(final NewsFoodPresenter presenter) {
    ...
    @Override
    public void refresh(final NewsFoodPresenter presenter) {
        lastId=0;
        Map<String,String> map=new HashMap<>();
        map.put("tid","4");
        map.put("lid",String.valueOf(lastId));
    ...
    @Override
    public void loadmore(final NewsFoodPresenter presenter) {
        Map<String,String> map=new HashMap<>();
        map.put("tid","4");
        map.put("lid",String.valueOf(lastId));
        map.put("count",String.valueOf(COUNT));
